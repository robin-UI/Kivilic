...
const LandingSec = () => {
  return (
    <div className="main flex md:justify-between flex-col sm:flex-row px-20 pt-14 sm:pt-32 mb-10">
       <div className='chair lg:hidden flex justify-center mb-6'>
        ...
        <div className="textArea flex md:justify-end flex-col md:mb-24 ">
            <h2 className='font-bold text-4xl text-center md:mb-40 text-[#20404A] sm:text-white mb-5'>Carrers</h2>
            <div>
